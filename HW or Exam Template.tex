...
%   and some convenient custom commands.
...
\begin{minipage}[t]{\textwidth}%
	...
	PH 652 \quad Quantum Mechanics II \par
	\underline{Homework Assignment 10-1} \par
\end{minipage}
...
% such as multiple choice, fill in the blank, etc.
...
\begin{parts}
\part[5]\label{ques:parta} The first part.
\droppoints

\part[15]\label{ques:partb} The second part.
\droppoints

\part[5]\label{ques:partc} The third part.
\droppoints
\end{parts}
\droptotalpoints
